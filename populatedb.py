...
category1 = Category(user_id=1, name="Foundation", image="/static/foundation.jpg")
session.add(category1)
session.commit()

category2 = Category(user_id=1, name="Concealer", image="/static/concealer.jpg")
session.add(category2)
session.commit()

category3 = Category(user_id=1, name="Blush", image="/static/blush.jpg")
session.add(category3)
session.commit()

category4 = Category(user_id=1, name="Eyeshadow", image="/static/eyeshadow.jpg")
session.add(category4)
session.commit()

category5 = Category(user_id=1, name="Lipstick", image="/static/lipstick.jpg")
session.add(category5)
session.commit()

category6 = Category(user_id=1, name="Bronzer", image="/static/bronzer.jpg")
